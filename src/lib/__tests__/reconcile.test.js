...
describe('Дивиденды наличными (04.09.2026)', () => {
  ...
  it('необъяснённый остаток уменьшается на дивиденды наличными', () => {
    ...
    assert.equal(unexplainedOwnerCash(25406476, 15337770, 9140000 + 3000000).unexplained, -2071294) // минус 2 млн — тоже не «ок»
    assert.equal(unexplainedOwnerCash(25406476, 15337770, 9140000 + 3000000).ok, false)
  })
