    ...
    <div className="card space-y-3">
      <div>
        ...
        <p className="text-xs text-slate-500 mt-1">
          Слова через «|» ищутся в комментарии изъятия без учёта регистра и с начала слова: «табак» найдёт «табака», но «лед» не найдёт «следующий». Первое совпавшее правило побеждает, поэтому «дост табак» должно стоять выше «табак».
