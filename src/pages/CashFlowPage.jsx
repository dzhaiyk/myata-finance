...
const CF_STRUCTURE = [
  { key: 'opening', label: 'ОСТАТКИ НА НАЧАЛО', type: 'header', color: 'bg-blue-600/20 text-blue-400' },
  ...
  { key: 'expenses_h', label: 'РАСХОДЫ', type: 'header', color: 'bg-red-600/20 text-red-400' },
  ...
  { key: 'dividends_h', label: 'ДИВИДЕНДЫ', type: 'header', color: 'bg-purple-600/20 text-purple-400' },
  ...
  { key: 'closing', label: 'ОСТАТКИ НА КОНЕЦ', type: 'header', color: 'bg-blue-600/20 text-blue-400' },
