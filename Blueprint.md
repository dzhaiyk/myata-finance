> Перенесено в docs/20-architecture/ (overview, data-model, conventions, security) и docs/30-decisions/, 2026-09-04. Файл оставлен до разрешения владельца на удаление.
