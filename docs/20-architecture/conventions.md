...
- Контракт кодов категорий: `category-contract.test.js` сверяет миграцию 008 с `categorize.js`, `PNL_STRUCTURE` и группами Cash Flow — при добавлении категории обновить все.
